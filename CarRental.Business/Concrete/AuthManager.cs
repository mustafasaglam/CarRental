...
namespace CarRental.Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegsterDto, string password)
        {
            byte[] passwordHash, passwordSalt;
            HashingHelper.CreatePasswordHash(password,out passwordHash, out passwordSalt);
            var user = new User
            {
                Email = userForRegsterDto.Email,
                FirstName = userForRegsterDto.FirstName,
                LastName = userForRegsterDto.LastName,
